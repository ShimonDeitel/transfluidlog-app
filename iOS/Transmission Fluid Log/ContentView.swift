...
struct ContentView: View {
    ...
    @State private var editingItem: FluidChange?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Transmission Fluid Log")
            .toolbar {
    ...
    private func editSheet(for item: FluidChange) -> some View {
...
struct EditItemView: View {
    ...
    @State var item: FluidChange
    var onSave: (FluidChange) -> Void
    var onDelete: () -> Void
